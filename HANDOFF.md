...
## LATEST ROUND
- 2026-09-03（收入主线 round 97）：为已安装用户增加 mcp-code-review schema 命令，直接输出随 Python 包携带的 JSON 结果契约，降低 CI 集成门槛；双语 README、试用说明和 CHANGELOG 已同步，CLI 测试 14 passed、安装文档测试 15 passed。尚未发布新的 PyPI 版本，未发送外部消息、未新增付费支出，漏斗仍为 0。
