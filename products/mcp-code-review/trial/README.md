...
The optional **Team Rules Pack** is a one-time `$49` add-on; [request a current secure Creem checkout link](mailto:731685147@qq.com?subject=AICraft%20Team%20Rules%20Pack%20checkout%20request&body=Team%20size%3A%20%5B%5D%0AMain%20languages%3A%20%5B%5D%0ACurrent%20review%20workflow%3A%20%5B%5D%0AWhat%20you%20need%20from%20the%20pack%3A%20%5B%5D). **Team Updates Starter** is `$19/month` or `$190/year` for up to 3 engineers; **Team Pilot** is `$99/month` or `$990/year` for up to 10 engineers with CI and tuning support. Scope and launch date are confirmed before charging.
