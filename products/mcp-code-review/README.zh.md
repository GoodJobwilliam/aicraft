...
免费的 MIT 服务器已经可以完成本地审查。如果团队需要现成规则档案和合并门禁，可[通过 Creem 安全购买 Team Rules Pack](https://www.creem.io/payment/prod_6Z3S3jGNPsCyRSqNi397ZY)：包含 Python/JS·TS/Go/Java 共 63 条验证规则、GitHub Actions 与 GitLab CI 模板，以及 20 条 LLM 审查提示词，终身更新。
